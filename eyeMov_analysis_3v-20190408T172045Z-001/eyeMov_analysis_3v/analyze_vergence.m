...
figure
subplot(3,1,1)
plot([0:0.01:10],20*sin([0:0.001:1]*2*pi)+40,'r','LineWidth',2);
hold on;
for i=1:36
...
subplot(3,1,2)
plot([0:0.01:10],-20*sin([0:0.001:1]*2*pi)+50,'r','LineWidth',2);
hold on;
for i=1:36
...
figure
subplot(3,1,1)
plot([0:0.01:10],20*cos([0:0.001:1]*2*pi),'r','LineWidth',2);
hold on;
for i=1:36
