function figuremaker(outputdata);
...
figure(9);
for i=1:length(outputdata(:,20));
hold on;
x=outputdata{i,25};
y=outputdata{i,20};
c = linspace(1,10,length(outputdata{i,20}));
scatter(x,y,[],c);
end
saveas(figure(9), ['H:/TURN TABLE/RPN project/TUtotaldata/figure/VP.fig']);
...
legend('velocity');
saveas(figure(10), ['H:/TURN TABLE/RPN project/TUtotaldata/figure/merged_velocity.fig']);
...
saveas(figure(1), ['H:/TURN TABLE/RPN project/TUtotaldata/figure/eye_trace.fig']);
...
saveas(figure(2), ['H:/TURN TABLE/RPN project/TUtotaldata/figure/freq_per_min.fig']);
...
saveas(figure(3), ['H:/TURN TABLE/RPN project/TUtotaldata/figure/freq_diff_sum.fig']);
...
saveas(figure(4), ['H:/TURN TABLE/RPN project/TUtotaldata/figure/freq_byduration.fig']);
...
legend('positive directed saccades','negative directed saccades','difference');
saveas(figure(5), ['H:/TURN TABLE/RPN project/TUtotaldata/figure/freq_byduration_median.fig']);
...
legend('difference','sum');
saveas(figure(6), ['H:/TURN TABLE/RPN project/TUtotaldata/figure/freq_byduration_diff_sum.fig']);
...
saveas(figure(7), ['H:/TURN TABLE/RPN project/TUtotaldata/figure/velocity.fig']);
