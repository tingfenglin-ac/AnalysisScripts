function varargout = scanbox_playground(varargin)
...
% Last Modified by GUIDE v2.5 22-May-2018 17:16:50
...
if(sbconfig.portcamera)
    ...
    if (flag)
        ...
        if(flag==false)
            ...
            dalsa =  videoinput('pcocameraadaptor', q.DeviceIDs{i}, 'USB 3.0');
            dalsa.FramesPerTrigger = inf;
            eval(sprintf('%s_init',sbconfig.pathcamera));   % init camera
        end
    end
