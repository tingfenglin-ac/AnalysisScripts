...
% foreground objects, and displaying results.
    ...
    function obj = setupSystemObjects()
        ...
        obj.reader = vision.VideoFileReader([FolderPath,FolderName]);
    ...
    function displayTrackingResults()
        ...
        if ~isempty(tracks)
            ...
            if ~isempty(reliableTracks)
                ...
                % Draw a velocity number on the frame_Ting
                frame = insertText(frame,[50 50], '0');
               
            end
            
                % Draw a velocity number on the frame_Ting
                frame = insertText(frame,[50 50], 'velocity');
